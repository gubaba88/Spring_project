...
<div class="container px-4 px-lg-5">
	<div class="viewBox">
		<form name="inPost" id="inPost" action="./NoticeInsert" method="post" enctype="multipart/form-data">
			<fieldset>
			<div>
				...
				<input type="radio" id="postTopic" name="postTopic" value="공지" checked><span>공지 &nbsp;</span>
